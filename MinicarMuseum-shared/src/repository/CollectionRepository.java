...
public interface CollectionRepository {
    public List<Collection> getCollectionByPersonId(int personId) throws Exception;
    public List<Collection> getCollectionsWithSeirse(int personId,String seirse) throws Exception;
